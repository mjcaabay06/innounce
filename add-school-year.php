										...
										<div class="col-md-6 col-sm-12 col-md-offset-3">
											<div class="panel panel-default border-panel card-view">
												<div class="panel-heading">
													<a href="school-year.php" class="pull-left" title="Back to school year"><i class="zmdi zmdi-chevron-left" style="color: rgba(23, 126, 193, 0.85);font-weight: bold;font-size: 25px;margin-right: 10px;"></i></a>
													<div class="pull-left">
														<h6 class="panel-title txt-dark">Add School Year</h6>
													</div>
												...
												<div class="panel-wrapper">
													<div class="panel-body">
														<div class="form-group">
															...
															<input type="text" class="form-control number-only" maxlength="4" name="tb-from" required="" id="tb-from" placeholder="Year From">
														</div>
														<div class="form-group">
															<label class="control-label mb-10" for="tb-to">Year To</label>
															<input type="text" class="form-control number-only" maxlength="4" required="" name="tb-to" id="tb-to" placeholder="Year To">
														</div>
													</div>
												</div>
		...
		$(document).ready(function(){
			...
			$("#btn-save-add").on('click', function(){
				...
				$.ajax({
					...
					type: 'post',
					data: { action: 'school-year', params: data  },
					success: function(response){
						$(".preloader").hide();
						var result = $.parseJSON(response);

						if (result["status"] == 'success') {
							$("#add-alert-message").html('<div class="alert alert-success">You have successfully created a school year.</div>');
							setTimeout(function(){
								window.location.href = 'school-year.php';
							},1000);
						} else {
							$("#add-alert-message").html('<div class="alert alert-danger">There was an error creating a school year.</div>');
						}
