			...
			$(".btn-delete").on("click", function(){
				...
				if (answer) {
					...
					$.ajax({
						...
						type: 'post',
						data: { action: 'subject', params: data  },
						success: function(response){
							...
							if (result["status"] == 'success'){
								...
								$("#del-alert-message").html('<div class="alert alert-success">Subject successfully deleted.</div>');
								setTimeout(function(){
									$("#del-alert-message").html('');
								},1500);
							} else {
								$("#del-alert-message").html('<div class="alert alert-danger">There was and error deleting the subject.</div>');
							}
