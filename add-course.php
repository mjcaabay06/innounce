										...
										<div class="col-md-6 col-sm-12 col-md-offset-3">
											<div class="panel panel-default border-panel card-view">
												<div class="panel-heading">
													<a href="course.php" class="pull-left" title="Back to courses"><i class="zmdi zmdi-chevron-left" style="color: rgba(23, 126, 193, 0.85);font-weight: bold;font-size: 25px;margin-right: 10px;"></i></a>
													<div class="pull-left">
														<h6 class="panel-title txt-dark">Add Course</h6>
													</div>
		...
		$(document).ready(function(){
			...
			$("#btn-save-add").on('click', function(){
				...
				$.ajax({
					...
					type: 'post',
					data: { action: 'school-course', params: data  },
					success: function(response){
						$(".preloader").hide();
						var result = $.parseJSON(response);

						if (result["status"] == 'success') {
							$("#add-alert-message").html('<div class="alert alert-success">You have successfully created a course.</div>');
							setTimeout(function(){
								window.location.href = 'course.php';
							},1000);
						} else {
							$("#add-alert-message").html('<div class="alert alert-danger">There was an error creating a course.</div>');
						}
