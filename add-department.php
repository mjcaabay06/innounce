										...
										<div class="col-md-6 col-sm-12 col-md-offset-3">
											<div class="panel panel-default border-panel card-view">
												<div class="panel-heading">
													<a href="department.php" class="pull-left" title="Back to department"><i class="zmdi zmdi-chevron-left" style="color: rgba(23, 126, 193, 0.85);font-weight: bold;font-size: 25px;margin-right: 10px;"></i></a>
													<div class="pull-left">
												...
												<div class="panel-wrapper">
													<div class="panel-body">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="tb-department" required="" id="tb-department" placeholder="Enter department">
														</div>
													</div>
												</div>
		...
		$(document).ready(function(){
			...
			$("#btn-save-add").on('click', function(){
				...
				$.ajax({
					...
					type: 'post',
					data: { action: 'school-department', params: data  },
					success: function(response){
						$(".preloader").hide();
						var result = $.parseJSON(response);

						if (result["status"] == 'success') {
							$("#add-alert-message").html('<div class="alert alert-success">You have successfully created a subject.</div>');
							setTimeout(function(){
								window.location.href = 'department.php';
							},1000);
						} else {
							$("#add-alert-message").html('<div class="alert alert-danger">There was an error creating a subject.</div>');
						}
