							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body  pa-0">
									<div class="profile-box">
										...
										<div class="social-info text-center" style="border-top: 0; padding: 15px">
											<h5 class="block weight-500 capitalize-font txt-danger"><?php echo $rowUser['first_name'] . ' ' . $rowUser['last_name'] ?></h5>
											<span style="color: #aaa">( <?php echo strtoupper($rowUser['type']) ?> )</span>
										</div>
									</div>
								</div>
							</div>
