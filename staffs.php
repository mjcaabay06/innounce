										...
										<div class="table-responsive">
											<table class="table mb-0">
												...
												<tbody>
													...
													?>
													<tr id="row-staff<?php echo $staff['user_id'] ?>" class="<?php echo $staff['status_id'] == 2 ? 'success' : '' ?>">
														...
														<td><button id="btn-edit" class="btn btn-primary btn-icon-anim btn-square btn-sm" title="Edit" data-id="<?php echo $staff['user_id'] ?>"><i class="fa fa-pencil"></i></button></td>
													</tr>
													<?php endwhile; ?>
												</tbody>
											</table>
