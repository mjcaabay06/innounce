										...
										<div class="col-md-6 col-sm-12 col-md-offset-3">
											<div class="panel panel-default border-panel card-view">
												<div class="panel-heading">
													<a href="subject.php" class="pull-left" title="Back to subjects"><i class="zmdi zmdi-chevron-left" style="color: rgba(23, 126, 193, 0.85);font-weight: bold;font-size: 25px;margin-right: 10px;"></i></a>
													<div class="pull-left">
														<h6 class="panel-title txt-dark">Add Subject</h6>
													</div>
		...
		$(document).ready(function(){
			...
			$("#btn-save-add").on('click', function(){
				...
				$.ajax({
					...
					type: 'post',
					data: { action: 'school-subject', params: data  },
